...
public class WarehouseTestContainer extends TestContainer {

    public WarehouseTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/warehouse/app.properties",
    ...
    public static class Common extends WarehouseTestContainer {

        public static final WarehouseTestContainer.Common INSTANCE = new WarehouseTestContainer.Common();
